export const projectsWeb = [
    ...
    {
        name: 'CodeMon',
        imageUrl: '/assets/images/codemon.png',
    ...
    {
        name: 'Drum Machine',
        imageUrl: '/assets/images/drum-machine.png',
    ...
    },
    {
        ...
        imageUrl: '/assets/images/amesite_website.png',
...
export const projectsMobile = [
    {
        name: 'Calculator',
        imageUrl: '/assets/images/calculator-rn.png',
    ...
    {
        name: 'DigiCoin',
        imageUrl: '/assets/images/digicoin-ios.png',
    ...
    {
        name: 'Your Decision',
        imageUrl: '/assets/images/yourDecision.png',
    ...
    },
    {
        ...
        imageUrl: '/assets/images/pitch-reference.png',
